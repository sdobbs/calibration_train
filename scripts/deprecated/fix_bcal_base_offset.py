...
def main():
    ...
    for run in runs:
        print "===%d==="%run
        off_assignment = ccdb_conn.get_assignment("/BCAL/base_time_offset", run, VARIATION)
        ...
        #f = TFile("/cache/halld/RunPeriod-2017-01/calib/ver06/hists/Run%06d/hd_calib_verify_Run%06d_001.root"%(run,run))
