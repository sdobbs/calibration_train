...
def main():
    ...
    for run in runs:
        print "===%d==="%run
        off_assignment = ccdb_conn.get_assignment("/FCAL/base_time_offset", run, VARIATION)
        ...
        #locHist = f.Get("Independent/Hist_Neutrals/FCALNeutralShowerDeltaT")
        ...
        try:
            ...
            fr = locHist.Fit("gaus", "SQ", "", maximum - 0.8, maximum + 0.8);
            mean = fr.Parameter(1);
