...
rootfiles = glob.glob("/cache/halld/RunPeriod-2017-01/calib/ver01/hists/Run0305??/hd_calib_final_*.root")
...
for pathname in sorted(rootfiles):
    f = TFile(pathname)
    #TAGM1DHist = f.Get("HLDetectorTiming/TRACKING/Tagger - RFBunch 1D Time")
