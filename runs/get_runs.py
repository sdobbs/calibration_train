...
#runs = db.select_runs("@is_2018production and @status_approved", 40000, 49000)
#runs = db.select_runs("@is_2018production", 50000, 59000)
#runs = db.select_runs("@is_2018production and status!=0", 50000, 56000)
#runs = db.select_runs("event_count > 100000", 60700, 60851)
...
runs = db.select_runs("@is_dirc_production", 60700, 60833)
