...
set CALIB_OPTIONS="-PHLDETECTORTIMING:DO_TDC_ADC_ALIGN=1 -PTOF:DELTA_T_ADC_TDC_MAX=500 -PSC:HIT_TIME_WINDOW=500 -PSC:DELTA_T_ADC_TDC_MAX=500 -PTAGHHit:DELTA_T_ADC_TDC_MAX=500 -PTAGMHit:DELTA_T_ADC_TDC_MAX=500 -PPSCHit:DELTA_T_ADC_TDC_MAX=500"
