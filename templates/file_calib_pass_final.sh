...
cp -v /home/gxproj3/work/calib_jobs/RunPeriod-2018-01/ccdb.sqlite ccdb.sqlite
...
#CALIB_PLUGINS=evio_writer,HLDetectorTiming,BCAL_TDC_Timing,CDC_amp,CDC_TimeToDistance,FCALpedestals,ST_Propagation_Time,imaging,pedestals,BCAL_LED,FCALpulsepeak,pi0fcalskim,pi0bcalskim,ps_skim,BCAL_inv_mass,trigger_skims,TOF_calib,TrackingPulls,TAGM_TW,exclusivepi0skim,omega_skim
#CALIB_PLUGINS=evio_writer,HLDetectorTiming,BCAL_TDC_Timing,CDC_amp,CDC_TimeToDistance,FCALpedestals,ST_Propagation_Time,imaging,pedestals,BCAL_LED,FCALpulsepeak,pi0fcalskim,pi0bcalskim,ps_skim,trigger_skims,TOF_calib,TAGM_TW,exclusivepi0skim,omega_skim
CALIB_PLUGINS=evio_writer,FCALpedestals,pedestals,BCAL_LED,FCALpulsepeak,pi0fcalskim,pi0bcalskim,ps_skim,trigger_skims,TOF_calib,TAGM_TW,exclusivepi0skim,omega_skim
...
# skims
SKIM_DIR=/cache/halld/${RUNPERIOD}/calib/ver01
#SKIM_DIR=$OUTPUTDIR
mkdir -p $SKIM_DIR
#
...
swif outfile data.omega.evio file:${SKIM_DIR}/omega/Run${RUN}/hd_rawdata_${RUN}_${FILE}.omega.evio
mkdir -p ${SKIM_DIR}/exclusivepi0/Run${RUN}
swif outfile data.exclusivepi0.evio file:${SKIM_DIR}/exclusivepi0/Run${RUN}/hd_rawdata_${RUN}_${FILE}.exclusivepi0.evio
