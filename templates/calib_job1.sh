...
mv -v ccdb_pass0.sqlite ccdb_pass1.sqlite
...
#rm -f ccdb.sqlite
#$CCDB_HOME/scripts/mysql2sqlite/mysql2sqlite.sh -hhallddb.jlab.org -uccdb_user ccdb | sqlite3 ccdb.verify.sqlite
#./run_calib_verify.sh

# need to debug SQLite creation
rm -f ccdb_pass2.sqlite
$CCDB_HOME/scripts/mysql2sqlite/mysql2sqlite.sh -hhallddb.jlab.org -uccdb_user ccdb | sqlite3 ccdb_pass2.sqlite
cp -v ccdb_pass2.sqlite ${BASEDIR}/sqlite_ccdb/ccdb_pass1.${RUN}.sqlite
