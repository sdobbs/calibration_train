...
if __name__ == "__main__":
    ...
    RCDB_SEARCH_MIN  = 60540  ## NEED TO FIX THESE RANGES
    RCDB_SEARCH_MAX  = 66000
    ...
    for run in RCDB_RUNS:
        ...
        for fnum in fnums:            
            cmd = "python HDSubmitCalibJobSWIF.py configs/data.config %s pass2-primex %d %d"%(RUNPERIOD,run,fnum)
            if DRY_RUN:
                print "run: "+cmd
            else:
                os.system(cmd)
