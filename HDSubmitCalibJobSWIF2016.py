...
class HDSubmitCalibJobSWIF:
    ...
    def AddEVIOJobToSWIF(self,run,filenum,the_pass,command_to_run,filename):
        """
    ...
    def SubmitJob(self, run_period, the_pass, run, filenum=1, filename=""):
        ...
        if the_pass == "pass1":
            ...
            self.AddEVIOJobToSWIF(run,filenum,the_pass,"file_calib_skim.sh", filename)
...
if __name__ == "__main__":
    ...
    if len(sys.argv)<=5:
        ...
        submitter.SubmitJob(sys.argv[2], sys.argv[3], int(sys.argv[4]), int(sys.argv[5]), sys.argv[6])
